            ...
            public void onSingleCallback(final ArrayList<Bitmap> bitmap, final Integer interval) {
                UiThreadExecutor.runTask("", new Runnable() {
                    ...
                    public void run() {
                        ...
                        ArrayList<Bitmap> oldBitmaps = bitmaps;
                        bitmaps.addAll(bitmap);
                        if (bitmaps.size() == oldBitmaps.size()) {
                            Toast.makeText(mContext, "总长" + bitmaps.size(), Toast.LENGTH_LONG).show();
                        }
...
//            videoThumbHolder.thumb.setOnClickListener(new OnClickListener() {
//                @Override
//                public void onClick(View v) {
